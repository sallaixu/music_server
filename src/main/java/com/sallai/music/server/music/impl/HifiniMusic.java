...
public class HifiniMusic extends AbstractMusic {
    ...
    private static String base32Encode(String str) {
        ...
        while (base32.length() % 8 != 0) {
            base32.append(PAD_CHAR);
        }

        return base32.toString().replace(PAD_CHAR, 'H');
    }
    ...
    public static void main(String[] args) {
        ...
        MusicInfoBean musicDetailInfo = new HifiniMusic().getMusicDetailInfo("thread-27176.htm");
...
//         }
//        String data = "Q6uEEbnszfPH3Fd2tHYyZDzh80ByHGAnWhdvMuymxD8Up7xuSubxjzhISdslzLocvUojbgwKdqh4A0ln"; // Replace with your input data
...
//        System.out.println("Generated parameter: " + result);
    ...
    public static String generateParam(String data) {
        ...
        String base32Encoded = base32Encode(outText.toString());
